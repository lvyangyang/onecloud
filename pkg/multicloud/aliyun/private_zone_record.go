...
func (client *SAliyunClient) DescribeZoneRecords(ZoneId string, offset int, limit int) (SPvtzRecords, error) {
...
func (client *SAliyunClient) GetAllZoneRecords(ZoneId string) ([]SPvtzRecord, error) {
	...
	for {
		records, err := client.DescribeZoneRecords(ZoneId, count, 20)
		if err != nil {
...
func (self *SPvtzRecord) GetPolicyParams() cloudprovider.TDnsPolicyTypeValue {
	return nil
}
