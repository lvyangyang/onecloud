...
func (client *SAliyunClient) DescribeZones(offset int, limit int) (SPrivateZones, error) {
...
func (client *SAliyunClient) GetICloudDnsZones() ([]cloudprovider.ICloudDnsZone, error) {
...
func (client *SAliyunClient) GetICloudDnsZoneById(id string) (cloudprovider.ICloudDnsZone, error) {
...
func (client *SAliyunClient) CreateICloudDnsZone(opts *cloudprovider.SDnsZoneCreateOptions) (cloudprovider.ICloudDnsZone, error) {
	return client.CreateZone(opts)
}
