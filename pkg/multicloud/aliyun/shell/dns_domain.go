...
func init() {
	...
	shellutils.R(&DomianListOptions{}, "domain-list", "List Domain", func(cli *aliyun.SRegion, args *DomianListOptions) error {
		sdomains, e := cli.GetClient().DescribeDomains(args.Offset, args.Limit)
		if e != nil {
			return e
		}
		printList(sdomains.Domains.Domain, sdomains.TotalCount, args.Offset, args.Limit, []string{})
		return nil
	})
	...
	shellutils.R(&SDomainRecordListOptions{}, "domainrecord-list", "List domainrecord", func(cli *aliyun.SRegion, args *SDomainRecordListOptions) error {
		srecords, e := cli.GetClient().DescribeDomainRecords(args.DOMAINNAME, args.Offset, args.Limit)
		if e != nil {
			return e
		}
		printList(srecords.DomainRecords.Record, srecords.TotalCount, args.Offset, args.Limit, []string{})
		return nil
	})
