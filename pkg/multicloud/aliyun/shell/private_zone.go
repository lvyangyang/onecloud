...
func init() {
	...
	shellutils.R(&PrivateZoneListOptions{}, "privatezone-list", "List privatezone", func(cli *aliyun.SRegion, args *PrivateZoneListOptions) error {
		szones, e := cli.GetClient().DescribeZones(args.Offset, args.Limit)
		if e != nil {
			return e
		}
		printList(szones.Zones.Zone, szones.TotalItems, args.Offset, args.Limit, []string{})
		return nil
	})
	...
	shellutils.R(&PrivateZoneRecordListOptions{}, "privatezonerecord-list", "List privatezonerecord", func(cli *aliyun.SRegion, args *PrivateZoneRecordListOptions) error {
		srecords, e := cli.GetClient().DescribeZoneRecords(args.ID, args.Offset, args.Limit)
		if e != nil {
			return e
		}
		printList(srecords.Records.Record, srecords.TotalItems, args.Offset, args.Limit, []string{})
		return nil
	})
