...
type ICloudProviderFactory interface {
	...
	IsSupportVpcPeering(bool, bool) bool
...
type ICloudProvider interface {
	...
	GetICloudInterVpcNetwork() (ICloudInterVpcNetwork, error)
...
func (self *SBaseProvider) GetICloudInterVpcNetwork() (ICloudInterVpcNetwork, error) {
	return nil, ErrNotImplemented
}
...
func (factory *baseProviderFactory) IsSupportVpcPeering(CrossCloud bool, CrossRegion bool) bool {
	return false
}
